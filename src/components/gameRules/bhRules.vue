<template>
  <div class="bhRules">
    <swiper class="swiper-container" :options="swiperOption" ref="mySwiper">
      ...
      <swiper-slide class="swiper-slide" :style="{backgroundImage:'url('+bg2+')'}">
        <slideTwo></slideTwo>
      </swiper-slide>
    </swiper>
...
<script type="text/ecmascript-6">
  ...
  import slideZero from './gameDescription.vue'
  import slideOne from './howToPlay.vue'
  import slideTwo from './bhBillboard.vue'
  ...
  export default {
    ...
    data () {
      return {
        ...
        bg2: require('../../assets/img/allen/bg-2.jpg'),
        swiperOption: {
          activeitem: 0,
